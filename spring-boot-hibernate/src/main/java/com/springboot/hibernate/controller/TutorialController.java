...
import com.springboot.hibernate.repository.TutorialRepo;
...
public class TutorialController {
    ...
    public ResponseEntity<Tutorial> createTutorial(@RequestBody Tutorial tutorial) {
        try {
            Tutorial _tutorial = tutorialRepo.save(new Tutorial(tutorial.getTitle(), tutorial.getDescription(), false));
